...
#undef LOG_TAG
#define LOG_TAG "UnsubscribeFuzzTest"
...
bool UnsubscribeFuzzTest(const uint8_t* data, size_t size)
{
    MessageParcel datas;
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::UnsubscribeFuzzTest(data, size);
    return 0;
}
} // namespace DeviceStatus
} // namespace Msdp

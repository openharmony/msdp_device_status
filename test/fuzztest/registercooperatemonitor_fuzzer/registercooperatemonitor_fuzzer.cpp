...
#include "registercooperatemonitor_fuzzer.h"
...
bool RegisterCooperateMonitorFuzzTest(const uint8_t* data, size_t size)
{
    MessageParcel datas;
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::RegisterCooperateMonitorFuzzTest(data, size);
    return 0;
}
} // namespace DeviceStatus
} // namespace Msdp

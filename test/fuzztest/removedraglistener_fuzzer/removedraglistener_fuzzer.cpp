...
namespace OHOS {
constexpr OHOS::HiviewDFX::HiLogLabel LABEL { LOG_CORE, Msdp::MSDP_DOMAIN_ID, "RemoveDraglistenerFuzzTest" };

bool RemoveDraglistenerFuzzTest(const uint8_t* data, size_t size)
{
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::RemoveDraglistenerFuzzTest(data, size);
    return 0;
}
...
namespace OHOS {
constexpr OHOS::HiviewDFX::HiLogLabel LABEL { LOG_CORE, Msdp::MSDP_DOMAIN_ID, "GetDragStateFuzzTest" };

bool GetDragStateFuzzTest(const uint8_t* data, size_t size)
{
    ...
    DelayedSingleton<DeviceStatusService>::GetInstance()->OnRemoteRequest(
        static_cast<uint32_t>(Msdp::DeviceInterfaceCode::GET_DRAG_DATA), datas, reply, option);
    return true;
}
} // namespace OHOS

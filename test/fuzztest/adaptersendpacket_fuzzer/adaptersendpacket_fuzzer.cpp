...
#include "adaptersendpacket_fuzzer.h"
...
bool AdapterSendPacketFuzzTest(const uint8_t* data, size_t size)
{
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::Msdp::DeviceStatus::AdapterSendPacketFuzzTest(data, size);

...
#include "getdragsummary_fuzzer.h"
...
#undef LOG_TAG
#define LOG_TAG "GetDragSummaryFuzzTest"
...
namespace OHOS {
bool GetDragSummaryFuzzTest(const uint8_t* data, size_t size)
{
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::GetDragSummaryFuzzTest(data, size);
    return 0;
}
} // namespace DeviceStatus
} // namespace Msdp

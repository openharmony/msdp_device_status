...
#include "adaptersendheartbeat_fuzzer.h"
...
bool AdapterSendHeartBeatFuzzTest(const uint8_t* data, size_t size)
{
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::Msdp::DeviceStatus::AdapterSendHeartBeatFuzzTest(data, size);
    return 0;
}
} // namespace DeviceStatus
} // namespace Msdp

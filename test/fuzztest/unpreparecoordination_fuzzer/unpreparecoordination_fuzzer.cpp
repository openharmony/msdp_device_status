...
namespace OHOS {
constexpr OHOS::HiviewDFX::HiLogLabel LABEL { LOG_CORE, Msdp::MSDP_DOMAIN_ID, "UnPrepareCoordinationFuzzTest" };
const std::u16string FORMMGR_DEVICE_TOKEN { u"ohos.msdp.Idevicestatus" };

bool UnprepareCoordinationFuzzTest(const uint8_t* data, size_t size)
{
    MessageParcel datas;
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::UnprepareCoordinationFuzzTest(data, size);
    return 0;
}

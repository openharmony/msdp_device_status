...
/**
 * @tc.name: DragDataUtilTest12
 * @tc.desc: Test DragData with dragAnimationType DEFAULT
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(DragDataUtilTest, DragDataUtilTest12, TestSize.Level0)
{
    CALL_TEST_DEBUG;
    std::optional<DragData> dragData = CreateDragData(MMI::PointerEvent::SOURCE_TYPE_MOUSE, 0, 1, false, 1);
    ASSERT_TRUE(dragData);
    ...
    ret = DragDataUtil::UnMarshalling(parcel, dragDataFromParcel, false);
    ASSERT_EQ(ret, RET_OK);
    ASSERT_EQ(dragData.value().dragAnimationType, dragDataFromParcel.dragAnimationType);
}

/**
 * @tc.name: DragDataUtilTest13
 * @tc.desc: Test DragData with dragAnimationType FOLLOW_HAND_MORPH
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(DragDataUtilTest, DragDataUtilTest13, TestSize.Level0)
{
    CALL_TEST_DEBUG;
    std::optional<DragData> dragData = CreateDragData(MMI::PointerEvent::SOURCE_TYPE_MOUSE, 0, 1, false, 1);
    ASSERT_TRUE(dragData);
...
/**
 * @tc.name: DragDataUtilTest14
 * @tc.desc: Test DragData equality with dragAnimationType
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(DragDataUtilTest, DragDataUtilTest14, TestSize.Level0)
{
    CALL_TEST_DEBUG;
    std::optional<DragData> dragData1 = CreateDragData(MMI::PointerEvent::SOURCE_TYPE_MOUSE, 0, 1, false, 1);
    ASSERT_TRUE(dragData1);
    dragData1.value().dragAnimationType = static_cast<int32_t>(DragAnimationType::DEFAULT);
    
    std::optional<DragData> dragData2 = CreateDragData(MMI::PointerEvent::SOURCE_TYPE_MOUSE, 0, 1, false, 1);
    ASSERT_TRUE(dragData2);
    dragData2.value().dragAnimationType = static_cast<int32_t>(DragAnimationType::DEFAULT);
    
    ASSERT_EQ(dragData1.value(), dragData2.value());
}

/**
 * @tc.name: DragDataUtilTest15
 * @tc.desc: Test DragData inequality with dragAnimationType
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(DragDataUtilTest, DragDataUtilTest15, TestSize.Level0)
{
    CALL_TEST_DEBUG;
    std::optional<DragData> dragData1 = CreateDragData(MMI::PointerEvent::SOURCE_TYPE_MOUSE, 0, 1, false, 1);
    ASSERT_TRUE(dragData1);
    ...
    std::optional<DragData> dragData2 = CreateDragData(MMI::PointerEvent::SOURCE_TYPE_MOUSE, 0, 1, false, 1);
    ASSERT_TRUE(dragData2);
    dragData2.value().dragAnimationType = static_cast<int32_t>(DragAnimationType::FOLLOW_HAND_MORPH);
    
    ASSERT_NE(dragData1.value(), dragData2.value());
}

/**
 * @tc.name: DragDataUtilTest16
 * @tc.desc: Test DragData with dragAnimationType marshalling cross device
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(DragDataUtilTest, DragDataUtilTest16, TestSize.Level0)
{
    CALL_TEST_DEBUG;
    std::optional<DragData> dragData = CreateDragData(MMI::PointerEvent::SOURCE_TYPE_MOUSE, 0, 1, false, 1);
    ASSERT_TRUE(dragData);
...
/**
 * @tc.name: DragDataUtilTest17
 * @tc.desc: Test DragData with negative dragAnimationType
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(DragDataUtilTest, DragDataUtilTest17, TestSize.Level0)
{
    CALL_TEST_DEBUG;
    std::optional<DragData> dragData = CreateDragData(MMI::PointerEvent::SOURCE_TYPE_MOUSE, 0, 1, false, 1);
    ASSERT_TRUE(dragData);

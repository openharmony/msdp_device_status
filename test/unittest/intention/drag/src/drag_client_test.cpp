...
HWTEST_F(DragClientTest, DragClientTest22, TestSize.Level0)
{
    ...
    StreamClient client;
    NetPacket pkt(MessageId::DRAG_STOP_END);
...
HWTEST_F(DragClientTest, DragClientTest24, TestSize.Level0)
{
    ...
    StreamClient client;
    NetPacket pkt1(MessageId::DRAG_STOP_END);
    ...
    g_dragClient.stopDragListener_ = stopDragListener;
    NetPacket pkt2(MessageId::DRAG_STOP_END);
 ...
 * @tc.desc: Test OnStopDragEnd thread safety with multiple listeners
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(DragClientTest, DragClientTest27, TestSize.Level0)
{
    ...
    for (int32_t i = 0; i < 3; i++) {
        ...
        int32_t ret = g_dragClient.OnStopDragEnd(clients[i], packets[i]);
        EXPECT_EQ(ret, RET_OK);
...
/**
 * @tc.name: DragClientTest37
 * @tc.desc: Test OnStopDragEnd boundary condition with multiple listeners
 * @tc.type: FUNC
 * @tc.require:
 */
HWTEST_F(DragClientTest, DragClientTest37, TestSize.Level0)
{
    CALL_TEST_DEBUG;

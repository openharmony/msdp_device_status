...
#ifndef SEQUENCEABLE_ONSCREEN_AWARENESS_OPTION_TEST_H
#define SEQUENCEABLE_ONSCREEN_AWARENESS_OPTION_TEST_H
...
#endif  // SEQUENCEABLE_ONSCREEN_AWARENESS_OPTION_TEST_H
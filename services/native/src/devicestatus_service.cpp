...
int32_t DeviceStatusService::StopDrag(int32_t result, bool hasSucceedAnimation)
{
    CALL_DEBUG_ENTER;
    int32_t ret = delegateTasks_.PostSyncTask(
        std::bind(&DeviceStatusService::OnStopDrag, this, result, hasSucceedAnimation));
    if (ret != RET_OK) {
...
int32_t DeviceStatusService::OnStopDrag(int32_t result, bool hasSucceedAnimation)
{
    CALL_DEBUG_ENTER;
    int32_t ret = dragMgr_.StopDrag(result, hasSucceedAnimation);
    if (ret != RET_OK) {

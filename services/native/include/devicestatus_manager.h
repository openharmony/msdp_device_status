...
public:
    ...
    int32_t Subscribe(BoomerangType type, std::string bundleName, sptr<IRemoteBoomerangCallback> callback);
    int32_t Unsubscribe(BoomerangType type, std::string bundleName, sptr<IRemoteBoomerangCallback> callback);

...
enum class BizCooperateStage {
    ...
    STAGE_PASSIVE_SAME_ACCOUNT,
    STAGE_CHECK_PEER_SWITCH,
    STAGE_INPUTEVENTBUILD_ENABLE,
...
enum class CooperateRadarErrCode {
    ...
    PASSIVE_DEASERIALIZATION_FAILED.
    PASSIVE_SAME_ACCOUNT_FAILED,
    CHECK_PEER_SWITCH_FAILED,
    INPUTEVENTBUILD_ENABLE_FAILED,
    PASSIVE_CURSOR_VISIBILITY_FAILED
};

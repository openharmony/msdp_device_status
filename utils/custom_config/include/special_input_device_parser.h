...
#ifndef MSDP_SPECIAL_INPUT_DEVICE_PARSER_H
#define MSDP_SPECIAL_INPUT_DEVICE_PARSER_H
...
#define SPECIAL_INPUT_DEVICE_PARSER OHOS::Msdp::DeviceStatus::SpecialInputDeviceParser::GetInstance()
#endif // MSDP_SPECIAL_INPUT_DEVICE_PARSER_H
...
private:
    ...
    static DeviceStatus::Type CheckGetSubType(napi_env env, size_t argc, napi_value *args, std::string &typeStr);
    static DeviceStatus::Type CheckGetUnsubType(napi_env env, size_t argc, napi_value *args, std::string &typeStr);

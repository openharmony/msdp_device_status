...
void OnCooperateMessage(::taihe::callback_view<void(CooperateMessage_t const&)> f, uintptr_t opq)
{
    EtsCooperateManager::GetInstance()->RegisterCooperateListener("cooperateMessage", f, opq);
}

void OffCooperateMessage(::taihe::optional_view<uintptr_t> opq)
{
    EtsCooperateManager::GetInstance()->UnRegisterCooperateListener("cooperateMessage", opq);
}

void OnCooperateMouse(::taihe::string_view networkId, ::taihe::callback_view<void(MouseLocation_t const&)> f,
    uintptr_t opq)
{
    EtsCooperateManager::GetInstance()->RegisterMouseListener(networkId.c_str(), f, opq);
}

void OffCooperateMouse(::taihe::string_view networkId, ::taihe::optional_view<uintptr_t> opq)
{
...
TH_EXPORT_CPP_API_OnCooperateMessage(OnCooperateMessage);
TH_EXPORT_CPP_API_OffCooperateMessage(OffCooperateMessage);
TH_EXPORT_CPP_API_OnCooperateMouse(OnCooperateMouse);
TH_EXPORT_CPP_API_OffCooperateMouse(OffCooperateMouse);
// NOLINTEND

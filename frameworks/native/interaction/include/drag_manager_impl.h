...
public:
    ...
    int32_t OnCollocateStart(const StreamClient& client, NetPacket& pkt);
    int32_t OnCollocateNotice(const StreamClient& client, NetPacket& pkt);
    int32_t OnCollocateStop(const StreamClient& client, NetPacket& pkt);

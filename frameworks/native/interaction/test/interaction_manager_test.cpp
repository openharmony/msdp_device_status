...
public:
    ...
    int32_t pointerId, std::pair<int32_t, int32_t> location);
...
std::optional<DragData> InteractionManagerTest::CreateDragData(int32_t width, int32_t height, int32_t sourceType,
    int32_t pointerId, std::pair<int32_t, int32_t> location)
{
    CALL_DEBUG_ENTER;
